...
extern const lws_ss_info_t ssi_coinbase_t;
...
int main(int argc, const char **argv)
{
	...
	lws_context_info_defaults(&info, "/app/coinbase-policy.json");
	...
	if (lws_ss_create(cx, 0, &ssi_coinbase_t, NULL, NULL, NULL, NULL)) {
